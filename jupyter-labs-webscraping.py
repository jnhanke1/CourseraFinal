...
pd.json_normalize(first_launch_table)
...
column_name = first_launch_table.find_all('th')
for th in column_name:
    name = extract_column_from_header(th)
    if name is not None and len(name) > 0:
        column_names.append(name)

#column_names = [title.text.strip() for title in column_name]

pd.json_normalize(column_names)
   ...
   # get table row 
    for rows in table.find_all("tr"):
        ...
        if flag:
            ...
            launch_dict['Date'].append(datatimelist[0].strip(',')) #append date. 
            ...
            customer = row[6].a.string if row[6].a and row[6].a.string else 'Unknown'
            print(customer)
